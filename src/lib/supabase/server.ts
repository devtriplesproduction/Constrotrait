...
/**
 * Creates a reusable Supabase client for Server Components, Server Actions,
    ...
    cookies: {
      ...
      setAll(cookiesToSet) {
        try {
          ...
          // This can be ignored if you have middleware or Server Actions refreshing user sessions.
        }
      },
    },
  });
