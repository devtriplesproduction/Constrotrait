-- Migration: 20260908000002_restore_eod_proxy_branch.sql
-- Description: Restores branch-scoped proxy checks and comp-off integration for EOD submission, while maintaining the self-approval fix.
