-- Migration: 20260908000003_secure_reporting_manager_branch.sql
-- Description: Enforces same-branch requirement for reporting-manager proxy submissions, reviews, and updates.
