-- Migration: 20260908000004_fix_eod_attendance_branch_id.sql
-- Description: Fixes EOD and Attendance insertions to correctly derive and set the branch_id from the target employee's profile.
...
BEGIN
  ...
  INSERT INTO public.eod_reports (
    ...
    p_location, p_blockers, p_photo_url, v_final_status, p_submitted_by, p_job_card_numbers, p_tomorrows_plan, v_employee_branch_id
