-- Migration: 20260910000000_unify_payroll_calculations.sql
-- Description: Unifies payroll basic_salary, hra, and allowance calculations to standard 50-20-30 split matching draft calculation
                    ...
                    LOOP
                        ...
                        IF v_ledger_emp_id = db_emp_id THEN
                            ...
                            ELSIF v_ledger_type ILIKE '%tds%' THEN
                                -- UNKNOWN: TDS formula not documented. Preserving configured behavior.
